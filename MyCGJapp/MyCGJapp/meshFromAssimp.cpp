...
bool LoadGLTexturesTUs(const aiScene* scene, char model_dir[])  // Create OGL textures objects and maps them to texture units.  
{
...
vector<struct MyMesh> createMeshFromAssimp(const aiScene* sc, char model_dir[]) {
